...
class _CreateVacancyScreenState extends State<CreateVacancyScreen> {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.all(4.0),
                            child: formField(descController, "Description", Icons.info),
                          ),
                          Padding(
                            padding: const EdgeInsets.all(4.0),
                          ...
                          Padding(
                            padding: const EdgeInsets.all(4.0),
                            child: formField(locationController, "Location", Icons.location_pin),
                          ),
                          Padding(
                            padding: const EdgeInsets.all(4.0),
                                ...
                                child: ElevatedButton(
                                  onPressed: _onProcess
                                    ...
                                    if (_form!.validate()) {
                                      ...
                                      publishVacancy(context, vacancy);
                                    }
                                  },
                                  child: Row(
  ...
  void publishVacancy(BuildContext context, Vacancy vacancy){
    BlocProvider.of<VacancyCubit>(context).createVacancy(vacancy);
  }
